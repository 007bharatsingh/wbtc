...
func getGenesisState(db ethdb.Database, blockhash common.Hash) (alloc types.GenesisAlloc, err error) {
	...
	case params.WBTCGenesisHash:
		genesis = DefaultWBTCGenesisBlock()
	case params.WBTCTGenesisHash:
		genesis = DefaultWBTCTGenesisBlock()
...
func SetupGenesisBlockWithOverride(db ethdb.Database, triedb *triedb.Database, genesis *Genesis, overrides *ChainOverrides) (*params.ChainConfig, common.Hash, error) {
	...
	if (stored == common.Hash{}) {
		if genesis == nil {
			log.Info("Writing default WBTC mainnet genesis block")
			genesis = DefaultWBTCGenesisBlock()
		} else {
	...
	if genesis == nil && stored != params.MainnetGenesisHash &&
		stored != params.WBTCTGenesisHash && stored != params.RialtoGenesisHash && stored != params.WBTCGenesisHash {
		newcfg = storedcfg
		applyOverrides(newcfg)
	}
...
func LoadChainConfig(db ethdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	...
	return params.BSCChainConfig, params.WBTCGenesisHash, nil
}
...
// DefaultWBTCGenesisBlock returns the WBTC mainnet genesis block.
func DefaultWBTCGenesisBlock() *Genesis {
	alloc := decodePrealloc(WBTCMainnetAllocData)
	return &Genesis{
		Config:     params.WBTCChainConfig,
		Nonce:      0,
		ExtraData:  hexutil.MustDecode(""),
		GasLimit:   40000000,
		Difficulty: big.NewInt(1),
...
func DefaultChapelGenesisBlock() *Genesis {
	alloc := decodePrealloc(WBTCTAllocData)
	return &Genesis{
...
// DefaultWBTCTGenesisBlock returns the BSC mainnet genesis block.
func DefaultWBTCTGenesisBlock() *Genesis {
	alloc := decodePrealloc(WBTCTAllocData)
	return &Genesis{
		Config:     params.WBTCTChainConfig,
		Nonce:      0,
		ExtraData:  hexutil.MustDecode(""),
		GasLimit:   40000000,
		Difficulty: big.NewInt(1),
